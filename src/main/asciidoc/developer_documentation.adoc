...
image::https://github.com/st-tu-dresden-praktikum/swt20w39/blob/main/src/main/asciidoc/models/design/customer.svg[]

[options="header"]
|=== 
|Klasse/Enumeration |Beschreibung
|Customer|Erweitert den Salespoint-UserAccount um eine Adresse und Bewegungseingeschränkt Boolean
|CustomerController|Spring MVC Controller zum Registrieren und Anzeigen von Nutzern
|CustomerDataInitializer|Test Benutzer
|CustomerManagement|Helfer-Klasse für Benutzer
|CustomerRepository|Helfer-Klasse für das Verwalten von UserAccounts
...
=== Customer
image::https://github.com/st-tu-dresden-praktikum/swt20w39/blob/main/src/main/asciidoc/models/design/seq_customer.svg[]
